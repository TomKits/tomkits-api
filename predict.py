...
def predict_disease():
    ...
    try:
        ...
        if "error" in response_data:
            ...
            return jsonify({"Response Text": response_data["error"]}), response.status_code
        ...
        if "confidence" in response_data and "predicted_class" in response_data:
            confidence_percentage = round(response_data["confidence"] * 100, 2)  # Convert to percentage
        ...
        return jsonify({"Response Text": "Unknown response format from prediction service"}), 500
